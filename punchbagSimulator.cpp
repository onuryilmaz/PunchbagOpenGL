/* 
 * File:   punchbagSimulator.cpp
 * Author: Onur Yilmaz - mail@onuryilmaz.me
 *
 * Main file for punchbag simulator in OpenGL
 */
...
int main(int argc, char **argv) {
    ...
    main_window = glutCreateWindow("Punchbag Simulator");
